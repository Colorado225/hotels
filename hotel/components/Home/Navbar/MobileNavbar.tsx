...
const MobileNavbar = () => {
  return (
    <div>
      ...
      {/* NavLinks */}
      <div className="text-white fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-rose-900 space-y-6 z-[10050]">
        {navlinks.map((link) => {
          return (
